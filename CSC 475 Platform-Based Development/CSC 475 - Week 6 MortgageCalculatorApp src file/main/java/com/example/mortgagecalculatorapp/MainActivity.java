...
import com.example.mortgagecalculatorapp.Loan;
import com.example.mortgagecalculatorapp.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TextView tenTwentyThirtyYears = (TextView) dialog.findViewById(R.id.ten_to_thirty_years);
                totalPayment.setText(currencyFormat.format(loan.monthlyPaymentsTillThirtyYears()));
